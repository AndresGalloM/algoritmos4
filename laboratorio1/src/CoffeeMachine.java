        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    Espreso espresso = new Espreso(espressoName, espressoRoast, espressoPrice, numberOfShots);
                ...
                case 2:
                    ...
                    while (true) {
                        ...
                        if (milkType.equals("whole") || milkType.equals("skim") ||  milkType.equals("oat") || milkType.equals("almond")) {
                            break;
                        } else {
                            System.out.println("Invalid input");
                            System.out.print("What milk type would you like? (whole, skim, almond, oat): ");
                    ...
                    if(syrupWanted.equals("yes")){
                        ...
                        syrupFlavor = keyboard.next();
                            ...
                            if (syrupFlavor.equals("vanilla") || syrupFlavor.equals("caramel") ||  syrupFlavor.equals("hazelnut")) {
                                break;
                            } else {
                                System.out.println("Invalid input");
                                System.out.print("Which flavor would you like? (vanilla, caramel, hazelnut): ");
