public class Main {
    public static void main(String[] args){
        ...
        students[0] = new Student(1,"Oracio", 10);
        // TODO 1:  create other 4 object of student class and assign to the array Students
        students[1] = new Student(2,"Marta", 18);
        students[2] = new Student(3,"Adrian", 30);
        students[3] = new Student(4,"Maluma", 31);
        students[4] = new Student(5,"Lionel", 22);
    ...
    public static void removeElement(int IndexToDelete, Student[] originalArray){
        if (IndexToDelete < 0 || IndexToDelete >= originalArray.length) {
            System.out.println("Invalid index. Please provide a valid index between 0 and " + (originalArray.length - 1));
            return;
        }
